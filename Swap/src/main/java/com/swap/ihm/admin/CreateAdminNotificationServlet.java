...
public class CreateAdminNotificationServlet extends MotherServlet {
	private static final long serialVersionUID = 1L;
	private static final String SUCCESS_PATH = "/Swap/account/notifications";
	private static final String CREATE_ADMIN_NOTIF_JSP = "/WEB-INF/CreateAdminNotification.jsp";

	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		sendToJSP(CREATE_ADMIN_NOTIF_JSP, request, response);
	}
